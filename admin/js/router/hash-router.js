(() => {
  "use strict";
  const allowed = new Set(["dashboard","invitados","confirmaciones","estadisticas","mesas","reportes","planeacion","presupuesto","timeline","contratos","esenciales","padrinos","regalos"]);
  let container;
